...
<style>
    ...
    <div class="relative flex min-h-screen ">
        <div class="flex flex-col items-center flex-auto min-w-0 bg-white sm:flex-row md:items-start sm:justify-center md:justify-start">
          <div class="relative items-center justify-center flex-auto hidden h-full p-10 overflow-hidden text-white bg-purple-900 bg-no-repeat bg-cover sm:w-1/2 xl:w-3/5 md:flex"
            ...
            <div class="absolute inset-0 z-0 opacity-75 bg-gradient-to-b from-indigo-600 to-blue-500"></div>
            <div class="z-10 w-full max-w-md">
              <div class="mb-6 font-bold leading-tight sm:text-4xl xl:text-5xl">Reference site about Lorem Ipsum..</div>
              <div class="font-normal text-gray-200 sm:text-sm xl:text-md"> What is Lorem Ipsum Lorem Ipsum is simply dummy
          ...
          <div class="w-2/5 w-full p-8 bg-white md:flex md:items-center md:justify-center sm:w-auto md:h-full xl:w-2/5 md:p-10 lg:p-14 sm:rounded-lg md:rounded-none">
            <div class="w-full max-w-md space-y-8">
              ...
              <div class="flex flex-row items-center justify-center space-x-3">
                <a href="https://www.behance.net/ajeeshmon" target="_blank"
                  class="inline-flex items-center justify-center text-lg font-bold transition duration-300 ease-in bg-blue-900 cursor-pointer w-11 h-11 rounded-2xl hover:shadow-lg"><img
                    class="w-4 h-4"
                ...
                <a href="https://twitter.com/ajeemon?lang=en" target="_blank"
                  class="inline-flex items-center justify-center text-lg font-bold text-white transition duration-300 ease-in bg-blue-400 cursor-pointer w-11 h-11 rounded-2xl hover:shadow-lg"><img
                    class="w-4 h-4"
                ...
                <a href="https://in.linkedin.com/in/ajeeshmon" target="_blank"
                  class="inline-flex items-center justify-center text-lg font-bold text-white transition duration-300 ease-in bg-blue-500 cursor-pointer w-11 h-11 rounded-2xl hover:shadow-lg"><img
              ...
              <div class="flex items-center justify-center space-x-2">
                ...
                <span class="font-normal text-gray-300">or continue with</span>
                <span class="w-16 h-px bg-gray-200"></span>
              </div>
              <form class="mt-8 space-y-6" action="#" method="POST" action="{{ route('login') }}">  
                <input type="hidden" name="remember" value="true">
                <div class="relative">
                  <div class="absolute mt-4 right-3"><svg xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 text-green-500"
                      fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path>
                    </svg>
                  </div>
                  <label class="ml-3 text-sm font-bold tracking-wide text-gray-700"> {{ __('E-Mail Address') }}:</label>
                  <input  id="email" type="email"
                    class="w-full px-4 py-2 text-base border-b  focus:outline-none rounded-2xl focus:border-indigo-500 form-input @error('email') border-red-500 @enderror"
                ...
                <div class="content-center mt-8">
                  <label class="ml-3 text-sm font-bold tracking-wide text-gray-700">
                    {{ __('Password') }}
                  </label>
                  <input
                    class="content-center w-full px-4 py-2 text-base border-b form-input rounded-2xl focus:outline-none focus:border-indigo-500  @error('password') border-red-500 @enderror" name="password"
                    required>
                ...
                <div class="flex items-center justify-between">
                  <div class="flex items-center">
                    <input id="remember" name="remember" type="checkbox"
                      class="w-4 h-4 bg-blue-500 border-gray-300 rounded focus:ring-blue-400 form-checkbox" {{ old('remember') ? 'checked' : '' }}>
                ...
                <div>
                  <button type="submit"
                    class="flex justify-center w-full p-4 font-semibold tracking-wide text-gray-100 transition duration-500 ease-in rounded-full shadow-lg cursor-pointer bg-gradient-to-r from-indigo-500 to-blue-600 hover:bg-gradient-to-l hover:from-blue-500 hover:to-indigo-600">
                    {{ __('Login') }}
                  </button>
                </div>
                ...
                <p class="flex flex-col items-center justify-center mt-10 text-center text-gray-500 text-md">
                  ...
                  <a href="{{ route('register') }}"
                    class="text-indigo-400 no-underline transition duration-300 ease-in cursor-pointer hover:text-blue-500 hover:underline">{{ __('Register') }}</a>
                </p>
                @endif
              </form>
            </div>
